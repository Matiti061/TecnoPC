...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(self.filtro_group.sizePolicy().hasHeightForWidth())
        self.filtro_group.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.tipo_label.sizePolicy().hasHeightForWidth())
        self.tipo_label.setSizePolicy(sizePolicy1)
        ...
        self.marca_edit = QLineEdit(self.filtro_group)
        self.marca_edit.setObjectName(u"marca_edit")

        self.horizontalLayout_6.addWidget(self.marca_edit)
        ...
        self.precio_min = QSpinBox(self.filtro_group)
        self.precio_min.setObjectName(u"precio_min")
        self.precio_min.setMaximum(2000000)

        self.horizontalLayout_6.addWidget(self.precio_min)
        ...
        self.precio_max = QSpinBox(self.filtro_group)
        self.precio_max.setObjectName(u"precio_max")
        self.precio_max.setMaximum(2000000)

        self.horizontalLayout_6.addWidget(self.precio_max)

        self.buscar_btn = QPushButton(self.filtro_group)
        self.buscar_btn.setObjectName(u"buscar_btn")

        self.horizontalLayout_6.addWidget(self.buscar_btn)
        ...
        self.elim_component_btn = QPushButton(self.tab)
        self.elim_component_btn.setObjectName(u"elim_component_btn")

        self.footer_layout.addWidget(self.elim_component_btn)

        self.replace_component_btn = QPushButton(self.tab)
        self.replace_component_btn.setObjectName(u"replace_component_btn")

        self.footer_layout.addWidget(self.replace_component_btn)
        ...
        self.formLayout_2.setWidget(0, QFormLayout.ItemRole.FieldRole, self.seller_comboBox)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.ItemRole.FieldRole, self.client_edit)

        self.new_sell_btn = QPushButton(self.groupBox)
        self.new_sell_btn.setObjectName(u"new_sell_btn")

        self.formLayout_2.setWidget(2, QFormLayout.ItemRole.FieldRole, self.new_sell_btn)
        ...
        self.replace_saleman_btn = QPushButton(self.groupBox_4)
        self.replace_saleman_btn.setObjectName(u"replace_saleman_btn")

        self.horizontalLayout_4.addWidget(self.replace_saleman_btn)

        self.elim_saleman_btn = QPushButton(self.groupBox_4)
        self.elim_saleman_btn.setObjectName(u"elim_saleman_btn")

        self.horizontalLayout_4.addWidget(self.elim_saleman_btn)
        ...
        sizePolicy1.setHeightForWidth(self.year_comboBox.sizePolicy().hasHeightForWidth())
        self.year_comboBox.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.calculation_comission.sizePolicy().hasHeightForWidth())
        self.calculation_comission.setSizePolicy(sizePolicy1)
        ...
        self.header_layout.setSizeConstraint(QLayout.SetDefaultConstraint)
        ...
        sizePolicy1.setHeightForWidth(self.shopComboBox.sizePolicy().hasHeightForWidth())
        self.shopComboBox.setSizePolicy(sizePolicy1)
    ...
    def retranslateUi(self, Form):
        ...
        self.elim_component_btn.setText(QCoreApplication.translate("Form", u"Eliminar Producto", None))
        self.replace_component_btn.setText(QCoreApplication.translate("Form", u"Remplazar Producto", None))
        ...
        self.label_9.setText(QCoreApplication.translate("Form", u"Total: $0", None))
        ...
        self.replace_saleman_btn.setText(QCoreApplication.translate("Form", u"Remplazar Vendedores", None))
        self.elim_saleman_btn.setText(QCoreApplication.translate("Form", u"Eliminar vendedores", None))
